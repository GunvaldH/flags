...
const AllTheFlags = () => {
    ...
    const getUSStatesFlagList = (cc: object):FlagType[] => {
        if (cc === undefined)
            return [];
        else
        {
    ...
    return (
        <div className="bg-slate-50">
            <h1 className="text-center">FLAGGENE I USA</h1>
            <div className="">
                 {(countrycodes) && presentFlags(sortedFlagList(getUSStatesFlagList(countrycodes)))}
            </div>
        </div>
    )
} 
